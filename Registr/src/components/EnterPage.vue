        ...
        <div class="registration-form">
          ...
          <form>
              ...
              <div class="social-icons">
                ...
                <img class="logo" src="../../img/google.png" alt="Twitter">
                <img class="logo" src="../../img/google.png" alt="Mail.ru">
              </div>
          </form>
        </div>
      </div>
...
.login{
  background-image: url(../../img/Back.png) center (center / cover) no-repeat;
}

    ...
    <div class="employees" v-else-if="currentPage === 'employees'">
      ...
      <div class="employees_card_container">
        ...
        <div class="employees_card" v-for="e in employees" :key="e.id">
          <div class="employees_compo-wrapper">
            <img :src="'http://95.163.243.5/' + e.avatar" alt="" class="card-avatar">
            <div class="employees_container">
      ...
      <div class="calendar_card">
        <div class="calendar_wrapper">
          <div class="calendar_compo-wrapper">
            <img :src="'http://95.163.243.5/' + selectedEmployees[0].avatar" class="card-avatar" alt="">
...
export default {
  ...
  methods: {
    ...
    async getfilial() {
        try {
            const response = await axios.get(`http://95.163.243.5/api/get_branch_bylink/?company=${this.username}&widget=${this.widgetname}`);

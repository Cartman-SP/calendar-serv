<template>
    <div v-if="isVisible" class="alert" :style="{ backgroundColor: color }">
      <p>{{ message }}</p>
      <svg @click="isVisible = false" width="8" height="8" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">

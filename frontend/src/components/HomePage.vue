    ...
    <div class="graph_container">
      <div class="graph">
        <div class="graph_header">
          ...
          <div class="graph_date">
            <p class="graph_date_text">Сегодня</p>
    ...
    <div class="static">
      <div class="static_header">
        ...
        <div class="static_header_container">
          <div
            :class="['static_date', { 'static_date_active': activeIndex === 0 }]"
            @click="setActive(0)"
          >
            <p class="static_date_text">День</p>
          </div>
          <div
            :class="['static_date', { 'static_date_active': activeIndex === 1 }]"
            @click="setActive(1)"
          >
            <p class="static_date_text">Неделя</p>
          </div>
          <div
            :class="['static_date', { 'static_date_active': activeIndex === 2 }]"
            @click="setActive(2)"
          >
            <p class="static_date_text">Месяц</p>
          </div>
          <div
            :class="['static_date', { 'static_date_active': activeIndex === 3 }]"
            @click="setActive(3)"
          >
            <p class="static_date_text">Квартал</p>
          </div>
          <div
            :class="['static_date', { 'static_date_active': activeIndex === 4 }]"
            @click="setActive(4)"
          >
      ...
      <div class="nav_people">
        <p class="nav_header">Кирилл Иванов</p>
        <p class="nav_header">3</p>
        <p class="nav_header">17 500 ₸</p>
        <div class="stars">

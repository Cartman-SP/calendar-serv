    ...
    <div class="choice" v-else-if="currentPage === 'choice'">
      ...
      <div class="choice_overview ">
        <div class="choice_rate_container">
          <p class="choice_rate">{{activeFilial.rating || '0.0'}}</p>
...
export default {
  ...
  methods: {
    async getfilial(i) {
      ...
      async getuslugi_by_specialist(ei ,fi){  /// возвращает все услуги по филиалам и сотрудникам, если сотрудников нет, то возвращает все услуги филиала

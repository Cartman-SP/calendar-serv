    ...
    <div class="main_side">
      ...
      <div class="content">
        <div class="top-group">
            ...
            <router-link :to="!uslugi.length > 0 ? '/dashboard/locked' : '/dashboard/personal'" class="main_text" :class="{ active: $route.path === '/dashboard/personal' }">
              <div :class="{'disabled-menu' : !uslugi.length > 0, 'main_menu' : uslugi.length > 0}">
                <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M20 16C20 13.2386 17.7614 11 15 11H10C13 11 16 13.4558 16 17.2792V18H20V16Z" fill="#6266EA"/>
                  <path d="M9 5.5C9 7.433 7.433 9 5.5 9C3.567 9 2 7.433 2 5.5C2 3.567 3.567 2 5.5 2C7.433 2 9 3.567 9 5.5Z" fill="#6266EA"/>
                </svg>
          ...
          <div class="line"></div>
          <div class="cards-group">
            <router-link  :to="employees.length > 0 && uslugi.length > 0 && filials.length > 0 ? '/dashboard/widgets' : '/dashboard/locked'" class="main_text" :class="{ active: $route.path === '/dashboard/widgets' }">
